...
url(r'^vue_get_opr_dashboard/', views.vue_get_opr_dashboard, name='vue_get_opr_dashboard', ),
    ...
    url(r'^vue_get_startup_public_detail/', views.vue_get_startup_public_detail,
        name='vue_get_startup_public_detail', ),
    url(r'^login_sns/', views.login_sns,
        name='login_sns', ),
url(r'^accounts/', include('allauth.urls')),
    ...
    url(r'^vue_get_opr_acc/', views.vue_get_opr_acc,
        name='vue_get_opr_acc', ),
    url(r'^opr_vue_get_startup_account/', views.opr_vue_get_startup_account,
        name='opr_vue_get_startup_account', ),
    url(r'^opr_vue_get_support_business_list/', views.opr_vue_get_support_business_list,
        name='opr_vue_get_support_business_list', ),

    url(r'^opr_vue_get_awarded/', views.opr_vue_get_awarded,
        name='opr_vue_get_awarded', ),
    ...
    #url(r'^del_revenue/', views.del_revenue, name='del_revenue', ),
    ...
    #url(r'^get_support_business_static_detail/', views.get_support_business_static_detail, name='get_support_business_static_detail', ),
    ...
    url(r'^vue_set_mng_support_business_1/', views.vue_set_mng_support_business_step_1, name='vue_set_mng_support_business_step_1', ),
    url(r'^vue_set_mng_support_business_2/', views.vue_set_mng_support_business_step_2, name='vue_set_mng_support_business_step_2', ),
    url(r'^vue_set_mng_support_business_3/', views.vue_set_mng_support_business_step_3, name='vue_set_mng_support_business_step_3', ),
    url(r'^vue_set_mng_support_business_4/', views.vue_set_mng_support_business_step_4, name='vue_set_mng_support_business_step_4', ),
    url(r'^vue_set_mng_support_business_5/', views.vue_set_mng_support_business_step_5, name='vue_set_mng_support_business_step_5', ),
    url(r'^vue_set_mng_support_business_6/', views.vue_set_mng_support_business_step_6, name='vue_set_mng_support_business_step_6', ),
    ...
    url(r'^vue_get_opr_dashboard/', views.vue_get_opr_dashboard, name='vue_get_opr_dashboard', ),
    url(r'^vue_get_kikwan_account/', views.vue_get_kikwan_account, name='vue_get_kikwan_account', ),
    ...
    #   url(r'^vue_my_favorite_set_detail/', views.vue_my_favorite_set_detail, name='vue_my_favorite_set_detail', ),
...
#url(r'^vue_favorite_support_business_list/', views.vue_favorite_support_business_list, name='vue_favorite_support_business_list', ),
    ...
    # url(r'^vue_get_support_business_title/', views.vue_get_support_business_title, name='vue_get_support_business_title', ),
...
url(r'^vue_channel_process_check/', views.vue_channel_process_check, name='vue_channel_process_check', ),
    ...
    # url(r'^vue_watch_course_history/', views.vue_watch_course_history, name='vue_watch_cvue_get_support_business_detailourse_history', ),
    ...
    url(r'^vue_set_support_business_information/', views.vue_set_support_business_information, name='vue_set_support_business_information', ),
    # url(r'^vue_get_support_business_information/', views.vue_get_support_business_information, name='vue_get_support_business_information', ),
    # url(r'^vue_set_service_show/', views.vue_set_service_show, name='vue_set_service_show', ),
    url(r'^vue_get_support_business_appliance/', views.vue_get_support_business_appliance, name='vue_get_support_business_appliance', ),
    ...
    #  url(r'^vue_get_support_business_optional_data/', views.vue_get_support_business_optional_data, name='vue_get_support_business_optional_data', ),
    ...
    url(r'^downloadit/', views.downloadit, name='downloadit', ),
    #url(r'support_business_submit', views.support_business_submit, name='support_business_submit', ),
    ...
    #url(r'vue_get_short_title', views.vue_get_short_title, name='vue_get_short_title', ),

    url(r'get_home_info', views.get_home_info, name='get_home_info', ),

    url(r'get_static_info_from_stattable', views.get_static_info_from_stattable, name='get_static_info_from_stattable', ),

    #url(r'cron_stat', views.cron_stat, name='cron_stat', ),

    url(r'^opr_get_support_business_static/', views.opr_get_support_business_static, name='opr_get_support_business_static', ),
    url(r'get_support_business_static', views.get_support_business_static, name='get_support_business_static', ),
    url(r'vue_get_support_business_select_name_1', views.vue_get_support_business_select_name_1, name='vue_get_support_business_select_name_1', ),
    url(r'vue_get_support_business_select_name_2', views.vue_get_support_business_select_name_2, name='vue_get_support_business_select_name_2', ),
    url(r'vue_get_support_business_select_name_3', views.vue_get_support_business_select_name_3, name='vue_get_support_business_select_name_3', ),
    url(r'vue_get_support_business_select_name_4', views.vue_get_support_business_select_name_4, name='vue_get_support_business_select_name_4', ),
    ...
    url(r'vue_get_course_all', views.vue_get_course_all,
        name='vue_get_course_all', ),
...
url(r'vue_get_startup_public_detail_news', views.vue_get_startup_public_detail_news, name='vue_get_startup_public_detail_news', ),
url(r'vue_get_startup_public_detail_news', views.vue_get_startup_public_detail_news, name='vue_get_startup_public_detail_news', ),
...
url(r'make_excel_kikwan', views.make_excel_kikwan, name='make_excel_kikwan', ),
url(r'excel_down_all_account', views.excel_down_all_account, name='excel_down_all_account', ),
url(r'set_support_business_status_trigger/', views.set_support_business_status_trigger, name='set_support_business_status_trigger', ),
url(r'vue_get_course_information/', views.vue_get_course_information, name='vue_get_course_information', ),
...
url(r'excel_down_support_business_gwanri_fav/', views.excel_down_support_business_gwanri_fav, name='excel_down_support_business_gwanri_fav', ),
...
url(r'vue_get_channel_static/', views.vue_get_channel_static, name='vue_get_channel_static', ),
url(r'mng_vue_get_kikwan_account_excel/', views.mng_vue_get_kikwan_account_excel, name='mng_vue_get_kikwan_account_excel', ),

url(r'get_usr_favored_data/', views.get_usr_favored_data, name='get_usr_favored_data', ),
