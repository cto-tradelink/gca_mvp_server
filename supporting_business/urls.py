...
urlpatterns = [
    ...
    url(r'^vue_update_startup_head_detail/', views.vue_update_startup_head_detail,
        name='vue_update_startup_head_detail', ),
    url(r'^vue_update_startup_with_application_1/', views.vue_update_startup_with_application_1,
        name='vue_update_startup_with_application_1', ),
    url(r'^vue_update_startup_with_application_2/', views.vue_update_startup_with_application_2,
        name='vue_update_startup_with_application_2', ),
    url(r'^vue_update_startup_with_application_3/', views.vue_update_startup_with_application_3,
        name='vue_update_startup_with_application_3', ),
    url(r'^vue_update_startup_with_application_4/', views.vue_update_startup_with_application_4,
        name='vue_update_startup_with_application_4', ),
    url(r'^vue_update_startup_with_application_6/', views.vue_update_startup_with_application_6,
        name='vue_update_startup_with_application_6', ),
