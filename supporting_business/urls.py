...
#         name='mng_account_kikwan_mng_account', ),
    ...
    url(r'mng_vue_get_startup_account/', views_paging.mng_vue_get_startup_account, name='mng_vue_get_startup_account', ),
...
url(r'vue_get_channel_statics_clip_update', views.vue_get_channel_statics_clip_update, name='vue_get_channel_statics_clip_update', ),
url(r'vue_get_channel_statics_path_update', views.vue_get_channel_statics_path_update, name='vue_get_channel_statics_path_update', ),
url(r'vue_get_channel_statics_course_update', views.vue_get_channel_statics_course_update, name='vue_get_channel_statics_course_update', ),
