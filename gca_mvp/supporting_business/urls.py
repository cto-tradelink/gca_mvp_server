...
urlpatterns = [
    ...
    url(r'^vue_add_interest_st/', views.vue_add_interest_st, name='vue_add_interest_st', ),
    url(r'^vue_add_interest_sb/', views.vue_add_interest_sb, name='vue_add_interest_sb', ),
